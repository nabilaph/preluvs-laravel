    ...
    <section class="card p-3 m-4">
        <div class="row section-margin mt-lg-5 mt-4">
            ...
            <div class="buttons col-lg-3 d-flex flex-column align-items-center">
                ...
                <a class="nav-link btn-prim me-lg-3 d-flex align-items-center justify-content-center w-100" href="#">
                    <i class='bx bx-cart-alt me-3'></i> Add to cart
                </a>
                <a class="nav-link btn-second me-lg-3 mt-3 d-flex align-items-center justify-content-center w-100" href="#">
