...
<section class="jumbotron text-center mt-5">
    ...
    <p>Star Rating</p>
    <h2 class="fa fa-star checked badge bg-white"> {{ $rating }} <span class="text-secondary">({{ $totalrating
            }})</span></h2>
    <span class=""></span>
        ...
        <div class="row row-cols-2 row-cols-lg-4 row-cols-sm-1 w-100 mt-2">
            ...
            <div class="col-lg col">
                <div class="card card-body p-lg-4 p-sm-3 rounded-4 mx-3 mb-3">
                    ...
                    <a href="/books/{{ $book->id }}""><h4 class=" fw-bolder title mt-3">{{ $book->book_title }}</h4></a>
